...
def build_prompt_single(paper: CanonicalPaper, goal: str, skill: SkillProfile) -> str:
    ...
    return (
        ...
        "If goals are provided, you MUST output goal_scores with entries for all goals in the provided order.\n"
        ...
        "\"goal_scores\":[{\"goal_id\":\"G1\",\"score\":0.50},{\"goal_id\":\"G2\",\"score\":0.00}]}\n\n"
